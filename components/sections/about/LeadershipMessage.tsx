...
export default function LeadershipMessage() {
  return (
    <section className="py-24 bg-navy relative overflow-hidden text-white/90">
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          {/* CEO portrait with Premium Styling */}
          <motion.div 
          ...
          >
            <div className="aspect-[4/5] bg-surface/10 rounded-[24px] overflow-hidden border border-white/10 relative group shadow-2xl">
              <Image 
              ...
              <div className="absolute bottom-8 left-8 right-8 bg-white/10 backdrop-blur-md p-6 rounded-[16px] border border-white/20">
                <h4 className="text-white font-heading font-black text-xl mb-1">Chief (Engr) Joseph Justin Akpan</h4>
          ...
          <div className="w-full lg:w-[60%]">
            ...
            <motion.h2 
              ...
              className="text-white text-3xl md:text-5xl font-heading font-black mb-8 leading-tight"
            >
            ...
            <motion.div 
              ...
              className="space-y-6 text-white/80 font-body text-lg leading-relaxed italic"
            >
              <p>
            ...
            >
              ...
              <div className="font-heading text-white font-black text-lg tracking-wider italic">
